...
#Every observation is fed into every decision tree. The most common outcome for each
#observation 
#is used as the final output. A new observation is fed into all the trees and 
...
#From the random forest shown above we can conclude that the shoesize and 
#score are the important factors deciding if someone is a native speaker or not.
