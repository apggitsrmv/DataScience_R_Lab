...
#we observe that it is rarely the case that the equation of the model is a 
#linear equation giving 
#a linear graph. Most of the time, the equation of the model of real world data 
#involves mathematical 
#functions of higher degree like an exponent of 3 or a sin function. In such a scenario, 
#the plot of the model gives a curve rather than a line. The goal of both linear and 
#non-linear regression
#is to adjust the values of the model's parameters to find the line or curve that 
#comes closest to your data.
...
#of the vertical distances of different points from the regression curve is minimized. 
