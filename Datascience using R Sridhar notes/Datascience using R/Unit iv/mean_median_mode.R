...
#Most of these functions are part of the R base package. These functions take R vector as an input 
...
#4.2+7=11.2/2= 5.6
x<-c(-21,-5,2,3,4.2,7.89876,8,12,18,54,78)#-odd number of values
# Find the median.
median.result <- median(x)
print(median.result)
t=median(x)/3
...
# mode is higest occurances of numbers among set of numbers will be considered, 
#it could work for numeric 
