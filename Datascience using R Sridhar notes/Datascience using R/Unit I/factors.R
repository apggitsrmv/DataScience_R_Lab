...
#it as levels. They can store both strings and integers. They are useful in the columns 
...
data <- c("East","West","East","North","North","East","West",
          "West","West","East","North","South","South")
# Create the factors
factor_data <- factor(data)
print(factor_data)
...
v <- gl(5, 3, labels = c("Bombay", "Delhi","Chennai", "coimbatore","Salem"))
print(v)

# factor is a function which find unique elements in a given set of vector
# data frame is set of vectors grouped together
# gl is reverese function of factor, which prints numbers of elements in a vector whose level is mentioned
